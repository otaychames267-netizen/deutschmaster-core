...
const resources = {
  en: { translation: {
    ...
    hero: { subtitle: "Master German with Confidence", description: "Prepare for TELC B1 & B2 with structured practice, realistic exam simulations, and a beautifully designed learning experience.", cta_trial: "Get Started", cta_plans: "View Plans", cta_login: "Login" },
    ...
    pricing: { title: "Simple, transparent pricing", monthly: "per month", trial: "Secure payment, instant activation", choose: "Get started", schriftlich_desc: "Written exam — Lesen, Hören, Sprachbausteine, Schreiben", muendlich_desc: "Oral exam — speaking simulation and practice", komplett_desc: "Full access — written + oral, complete preparation" },
  ...
  de: { translation: {
    ...
    hero: { subtitle: "Deutsch mit Zuversicht meistern", description: "Bereite dich auf TELC B1 & B2 vor — strukturierte Übungen, realistische Prüfungssimulationen.", cta_trial: "Jetzt starten", cta_plans: "Pläne ansehen", cta_login: "Anmelden" },
    ...
    pricing: { title: "Einfache, transparente Preise", monthly: "pro Monat", trial: "Sichere Zahlung, sofortige Freischaltung", choose: "Jetzt starten", schriftlich_desc: "Schriftliche Prüfung — Lesen, Hören, Sprachbausteine, Schreiben", muendlich_desc: "Mündliche Prüfung — Sprachsimulation und Übung", komplett_desc: "Vollzugang — schriftlich + mündlich" },
  ...
  ar: { translation: {
    ...
    hero: { subtitle: "تعلم الألمانية بثقة", description: "استعد لامتحان TELC B1 و B2 مع تمارين منظمة ومحاكاة واقعية للامتحان.", cta_trial: "ابدأ الآن", cta_plans: "عرض الخطط", cta_login: "دخول" },
    ...
    pricing: { title: "أسعار بسيطة وشفافة", monthly: "شهرياً", trial: "دفع آمن، تفعيل فوري", choose: "ابدأ الآن", schriftlich_desc: "الامتحان الكتابي", muendlich_desc: "الامتحان الشفوي", komplett_desc: "وصول كامل" },
  ...
  fr: { translation: {
    ...
    hero: { subtitle: "Maîtrisez l'allemand avec confiance", description: "Préparez TELC B1 & B2 avec des exercices structurés et des simulations réalistes.", cta_trial: "Commencer", cta_plans: "Voir les plans", cta_login: "Connexion" },
    ...
    pricing: { title: "Tarifs simples et transparents", monthly: "par mois", trial: "Paiement sécurisé, activation immédiate", choose: "Commencer", schriftlich_desc: "Écrit — Lesen, Hören, Sprachbausteine, Schreiben", muendlich_desc: "Oral — simulation et pratique", komplett_desc: "Accès complet" },
  ...
  es: { translation: {
    ...
    hero: { subtitle: "Domina el alemán con confianza", description: "Prepárate para TELC B1 y B2 con ejercicios estructurados y simulaciones realistas.", cta_trial: "Empezar", cta_plans: "Ver planes", cta_login: "Entrar" },
    ...
    pricing: { title: "Precios simples", monthly: "al mes", trial: "Pago seguro, activación instantánea", choose: "Empezar", schriftlich_desc: "Escrito", muendlich_desc: "Oral", komplett_desc: "Acceso completo" },
  ...
  it: { translation: {
    ...
    hero: { subtitle: "Padroneggia il tedesco con sicurezza", description: "Preparati a TELC B1 e B2 con esercizi strutturati e simulazioni realistiche.", cta_trial: "Inizia ora", cta_plans: "Vedi piani", cta_login: "Accedi" },
    ...
    pricing: { title: "Prezzi semplici", monthly: "al mese", trial: "Pagamento sicuro, attivazione immediata", choose: "Inizia ora", schriftlich_desc: "Scritto", muendlich_desc: "Orale", komplett_desc: "Accesso completo" },
  ...
  tr: { translation: {
    ...
    hero: { subtitle: "Almancayı güvenle öğren", description: "TELC B1 ve B2 için yapılandırılmış alıştırmalar ve gerçekçi sınav simülasyonları.", cta_trial: "Başla", cta_plans: "Planları gör", cta_login: "Giriş" },
    ...
    pricing: { title: "Basit fiyatlandırma", monthly: "aylık", trial: "Güvenli ödeme, anında aktivasyon", choose: "Başla", schriftlich_desc: "Yazılı sınav", muendlich_desc: "Sözlü sınav", komplett_desc: "Tam erişim" },
