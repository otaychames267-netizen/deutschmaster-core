 ...
 * content: Inhalt, Meinung, Erfahrung, Vor-/Nachteile, Prüfungsfragen,
 * Wortschatz) plus a grid of plain-text-only topic cards (just the raw
 * source text, safe to show everyone). The interactive tabbed detail view
 * this page used earlier this session is retired — everything beyond the
 * plain source text now lives exclusively in the protected PDF, so casual
 * scraping of the native page yields no exam-answer content.
 *
