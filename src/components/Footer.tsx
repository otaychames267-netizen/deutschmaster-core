  ...
  return (
    <footer className="border-t bg-muted/30 mt-16">
      <div className="container mx-auto px-4 py-10 grid gap-6 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-2 font-bold"><GraduationCap className="h-5 w-5 text-accent" /> DeutschMaster</div>
        ...
        <div className="text-sm text-muted-foreground md:text-right">© {new Date().getFullYear()} DeutschMaster. {t("footer.rights")}.</div>
      </div>
    </footer>
  );
}
