  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 pb-10">
      ...
      <div className="flex items-center justify-start">
        <Link to={`/${seg}/muendlich/vorbereitung/teil-2` as never} className="flex items-center gap-2 rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-semibold text-muted-foreground hover:text-foreground hover:bg-muted transition-all">
