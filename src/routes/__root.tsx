...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "TELC B2 preparation, done properly — structured practice, realistic simulations, AI-powered feedback." },
      ...
      { name: "twitter:description", content: "TELC B2 preparation, done properly." },
