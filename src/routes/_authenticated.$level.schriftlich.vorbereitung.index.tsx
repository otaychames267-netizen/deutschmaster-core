...
function schreibenParts(seg: "b1" | "b2" | undefined) {
  ...
  return [
    ...
    { label: "Meine Struktur — Produkt-Beschwerde", to: "/schriftlich/vorbereitung/schreiben/produkt-karten" },
    { label: "Meine Struktur — Service-Beschwerde", to: "/schriftlich/vorbereitung/schreiben/service-karten" },
  ];
}
    ...
    <div className="mx-auto max-w-4xl space-y-6 pb-10">
      ...
      <div>
        ...
        <div className="mb-2 flex items-center gap-1.5 text-xs text-muted-foreground">
          <Link to={`/${seg}/schriftlich` as never} className="hover:text-foreground transition-colors">Schriftlich</Link>
          <span>/</span>
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-blue-500/20 bg-blue-500/5 p-4">
        ...
        <p className="text-sm text-foreground">
          <strong>Study strategy:</strong> Start with Lesen — highest-weighted section. Then Hören, then Sprachbausteine. Practise Schreiben last. Once confident, run a full <Link to={`/${seg}/schriftlich/pruefung` as never} className="font-bold text-blue-500 hover:underline">Prüfungssimulation</Link>.
        </p>
      </div>
